            ...
            <SectionHeading
              ...
              title={
                <span className="text-white">
                  Learning Without <span className="text-gradient-amber">Borders.</span>
                </span>
              }
              sub={
                    ...
                    <span className="mt-3 flex flex-wrap gap-1.5">
                      {c.curricula.map((cur) => (
                        <span
                          key={cur}
                          className={cn(
                            'rounded-lg px-2 py-1 text-[10.5px] font-extrabold transition-colors',
                            on ? 'bg-amber-500/20 text-amber-300' : 'bg-white/[0.07] text-navy-300',
                          )}
                        >
                          {cur}
                        </span>

...
const NEXT_STEPS = [
  ...
  { icon: 'rocket' as const, t: 'The demo runs', b: '45 real teaching minutes, then honest feedback.' },
];
  ...
  return (
    <>
      <PageHero
        ...
        sub="45 real teaching minutes with a teacher chosen for your child's board and grade. No card, no commitment."
              ...
              >
                ...
                <div className="mt-6 grid w-full max-w-md gap-2.5 text-left">
                  {[
                    ...
                    'The demo runs as a real 45-minute lesson',
                  ].map((s, i) => (
